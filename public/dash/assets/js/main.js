...
$(function() {
  ...
  MINOVATE.global = {
    ...
    layout: function() {
      var defaultHeaderScheme = 'scheme-default',
          ...
          defaultBasebarVisibility = 'basebar-hidden',
          defaultAppClasses = 'scheme-default default-scheme-color header-fixed aside-fixed rightbar-hidden basebar-hidden';
      ...
      $toggleRightbarEl.on('click', function() {
        if ($body.hasClass('rightbar-hidden')) {
          ...
          $body.removeClass('rightbar-show').addClass('rightbar-hidden');
           ...
           $toggleBasebarEl.on('click', function() {
        if ($body.hasClass('basebar-hidden')) {
          $body.removeClass('basebar-hidden').addClass('basebar-show');
        } else {
          $body.removeClass('basebar-show').addClass('basebar-hidden');
        }
      });
  ...
  var $window = $(window),
      ...
      $toggleBasebarEl = $('.toggle-base-sidebar'),
      $pickDateEl = $('.pickDate'),
